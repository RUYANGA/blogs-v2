  ...
  return (
    <aside className=" max-lg:hidden">
        ...
        <div>
          <Card shadow="none" radius="sm" className="border">
            <CardHeader className="text-2xl font-bold">
              RUYANGA Community is a community of amazing developers
            </CardHeader>
            <CardBody>
      ...
      <Card shadow="none" className="pt-4">
        <CardHeader>
          RUYANGA blog A constructive and inclusive social network for software
        ...
        <CardFooter>Made with love and Nextjs. RUYANGA blog © 2025.</CardFooter>
      </Card>
    </aside>
  );
};
